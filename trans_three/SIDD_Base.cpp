...
// V: I added this function to calculate the residual superhelical density
//    n =  number of denatured bases
//double SIDD_Base::calc_alpha_res(int n)
//{/
...
//    }
//    else{
 //       double t1 = 4.0*PI*PI*C*(A*alpha + n) ;
  //      double t2 = A*(4.0*PI*PI*C + n*K) ;
   //     return t1/t2 ;
 //   }
//}
